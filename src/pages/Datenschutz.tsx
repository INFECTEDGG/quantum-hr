...
const content = {
  de: {
    ...
    sections: [
      ...
      ["Cookies und externe Dienste", "Wir speichern notwendige Einstellungen wie Sprach- und Cookie-Auswahl lokal im Browser. Optionale Analyse und Performance-Messung mit Vercel Analytics und Speed Insights wird nur geladen, wenn Sie im Cookie-Banner zugestimmt haben. Ihre Auswahl können Sie jederzeit über die Cookie-Einstellungen im Footer ändern."],
  ...
  en: {
    ...
    sections: [
      ...
      ["Cookies and external services", "We store necessary settings such as language and cookie choices locally in the browser. Optional analytics and performance measurement through Vercel Analytics and Speed Insights is loaded only if you have consented in the cookie banner. You can change your selection at any time through the cookie settings in the footer."],
