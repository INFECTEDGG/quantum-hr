      ...
      <div className="container relative">
        ...
        >
          ...
          <blockquote className="mt-4 font-display text-2xl md:text-4xl font-medium leading-[1.25] tracking-tight">
            AI Enable IT hat uns nicht nur beraten, sondern unser HR-Team direkt an der Tastatur befähigt. Die Automatisierung ist enorm. Der Fokus auf Datenschutz ist{" "}
